...
\begin{figure}[!ht]
  \includegraphics[width=\textwidth,height=0.35\textheight,keepaspectratio]{m1e-3_loss.png}
  \caption{Training loss for $\eta = 0.001$}
  \label{fig:mnist_three_loss}
\end{figure}

\begin{figure}[!ht]
  \includegraphics[width=\textwidth,height=0.35\textheight,keepaspectratio]{m1e-3_accuracy.png}
...
\begin{figure}[!ht]
  \includegraphics[width=\textwidth,height=0.35\textheight,keepaspectratio]{m5e-1_loss.png}
  \caption{Training loss for $\eta = 0.5$}
  \label{fig:mnist_one_loss}
\end{figure}

\begin{figure}[!ht]
  \includegraphics[width=\textwidth,height=0.35\textheight,keepaspectratio]{m5e-1_accuracy.png}
